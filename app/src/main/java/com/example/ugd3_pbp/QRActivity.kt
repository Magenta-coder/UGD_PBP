...
import com.example.ugd3_pbp.databinding.ActivityQractivityBinding
...
class QRActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding.cameraBtn.setOnClickListener(this@QRActivity)
        binding.galleryBtn.setOnClickListener(this@QRActivity)
        binding.scanBtn.setOnClickListener(this@QRActivity)
